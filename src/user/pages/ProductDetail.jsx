                    ...
                    <div className="row">
                        <div className="col-md-5 col-xl-6">
                            ...
                            {/* <div className="slider slider-nav mt-4">
                                <div>
                                    <img src="../assets/images/products/product-single-img-1.jpg" alt="" className="w-100 rounded" />
                                </div>
                                <div>
                                    <img src="../assets/images/products/product-single-img-2.jpg" alt="" className="w-100 rounded" />
                                </div>
                                <div>
                                    <img src="../assets/images/products/product-single-img-3.jpg" alt="" className="w-100 rounded" />
                                </div>
                                <div>
                                    <img src="../assets/images/products/product-single-img-1.jpg" alt="" className="w-100 rounded" />
                                </div>
                                <div>
                                    <img src="../assets/images/products/product-single-img-4.jpg" alt="" className="w-100 rounded" />
                                </div>
                            </div> */}
                        </div>
