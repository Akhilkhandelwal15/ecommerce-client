                                ...
                                <div className="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0 border-0">
                                    <div className="border-bottom p-5 d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#!" className="text-muted">
                                            <button className="btn btn-ghost-secondary btn-icon rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Mark all as read">
                            ...
                            <li className="dropdown ms-4">
                                ...
                                <div className="dropdown-menu dropdown-menu-end p-0">
                                    ...
                                    <div className="border-top px-5 py-3">
                                        <button  className="btn p-0 border-0 bg-transparent" onClick={handleLogout}>Log Out</button>
                                    </div>
                                </div>
                            </li>
                        </ul>
